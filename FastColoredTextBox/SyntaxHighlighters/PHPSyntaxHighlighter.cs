...
namespace FastColoredTextBoxNS {
    ...
    public class PHPSyntaxHighlighter : SyntaxHighlighterBase {
        ...
        public static readonly Regex PHPNumberRegex;
        public static readonly Regex PHPStringRegex;
        public static readonly Regex PHPVarRegex;

        static PHPSyntaxHighlighter() {
