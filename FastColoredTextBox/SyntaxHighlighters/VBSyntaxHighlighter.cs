...
namespace FastColoredTextBoxNS {
    ...
    public class VBSyntaxHighlighter : SyntaxHighlighter {
        ...
        public static readonly Regex VBKeywordRegex;
        public static readonly Regex VBNumberRegex;
        public static readonly Regex VBStringRegex;


        static VBSyntaxHighlighter() {
